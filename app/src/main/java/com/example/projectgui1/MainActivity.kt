...
fun LogIn(navController: NavHostController, pseudoUsuarioViewModel: pseudoViewModel) {
    ...
    Column(
        ...
        //validar usuario
        Button(onClick = { enter_application(pseudoUsuarioViewModel.agregarUsuario(email,password),navController = navController) },
            colors = ButtonDefaults.buttonColors(backgroundColor = Color.White),
            modifier = Modifier
                .padding(top = 130.dp)
                .size(width = 250.dp, height = 50.dp),
...
fun Watchlist(navController: NavHostController, pseudoUsuarioViewModel: pseudoViewModel) {
    ...
    Column( horizontalAlignment = Alignment.CenterHorizontally,
        ...
        Row {
            Button(
                onClick = { contenidoViewModel.agregar_peliculas_wachlist_v(text) },
                colors = ButtonDefaults.buttonColors(backgroundColor = Color.Black),
                modifier = Modifier
                    .padding(top = 20.dp)
                    .size(width = 120.dp, height = 55.dp),
